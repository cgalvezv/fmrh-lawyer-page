    ...
    <>
      <header className="header-area style-4">
        <div className="nav-left">
          ...
          <div className={showMobileMenu === 1 ? "main-nav show-menu" :"main-nav"}>
            <div className="mobile-logo-area d-xl-none d-flex justify-content-between align-items-center">
              ...
              <div onClick={handleMobileMenu} className="menu-close-btn">
                <i className="bi bi-x-lg text-black" />
              </div>
            </div>
            ...
            <div className="d-xl-none d-block">
              <div className="eg-btn btn--primary btn--lg d-xl-none d-flex">
                <Link href="/contact"><a><i className="bi bi-dash-lg" />1º consulta gratis</a></Link>
              </div>
            </div>
          ...
          <Link href="/contact" ><a className="eg-btn btn--primary2 sibling2  btn--lg2 d-xxl-flex d-none"><i className="bi bi-dash-lg" />1º consulta gratis<i className="bi bi-chevron-right" /></a></Link>
        </div>
