...
function Header() {
  ...
  const handleMobileMenu = () => {
    if (showMobileMenu === false || 0 === showMobileMenu) {
      setMobileMenu(1);
    } else {
      setMobileMenu(false);
    }
    ...
    <>
      <header className="header-area style-4">
        <div className="nav-left">
          ...
          <a className="eg-btn btn--primary2 sibling2  btn--lg2 d-xxl-flex d-none" onClick={scrollToContactSection} ><i className="bi bi-dash-lg" />Contactar<i className="bi bi-chevron-right" /></a>
        </div>
        <div className="nav-right d-flex jsutify-content-end align-items-center gap-5">
          <div className="ps-4 pe-4 phone-call sibling2 d-xl-flex justify-content-center align-items-center flex-row">
            ...
            <div className="number">
              <span>Contacto</span>
              <h5><a href="tel:+56974642737">+569 746 427 37</a></h5>
            </div>
          </div>
        </div>
      </header>
