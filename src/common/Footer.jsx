            ...
            <div className="row gy-5">
              <div className="col-lg-6 col-md-6">
                <div className="footer-about">
                  <img src="assets/images/icons/fr-logo-white-transparent.png" alt="image" height={50} width={50}/>
                ...
                <div className="footer-item">
                  ...
                  <ul className="contact-list">
                    <li>
                      ...
                      <div className="text">
                        <a href="tel:+56974642737">+569 746 427 37</a>
                        <a href="tel:+56931178918" className="mb-0">+569 311 789 18</a>
                      </div>
                    </li>
                    <li>
                      <div className="icon">
                      ...
                      <div className="text">
                        <a href="mailto:contacto@fabiarojasabogada.cl">contacto@fabiarojasabogada.cl</a>
                        <a href="mailto:fmrh.abogada@gmail.com" className="mb-0">fmrh.abogada@gmail.com</a>
                      </div>
                    </li>
                    <li>
                      <div className="icon">
                      ...
                      <div className="text">
                        Estado 50, Oficina C, Curicó, Región del Maule, Chile
                      </div>
                    </li>
                  </ul>
                </div>
          ...
          <div className="footer-bottom">
            <div className="row d-flex align-items-center g-3">
              <div className="col-lg-6 d-flex justify-content-lg-start justify-content-center text-lg-start text-center px-1">
                <p>Copyright 2022 Developed By <a className="egns-lab">cgalvezv</a> | Design By <a className="egns-lab">Egens Lab</a></p>
              </div>
